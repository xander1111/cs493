...
app.get("/messages", requireAuthorization, async (req, res, next) => {
    console.log(`messages requested by ${req.locals.user}`);
...
app.get("/messages/:id", requireAuthorization, async (req, res, next) => {
    const collection = db.collection("messages");
...
app.post("/messages", requireAuthorization, async (req, res, next) => {
    const collection = db.collection("messages");
...
app.delete('/messages/:id', requireAuthorization, async (req, res, next) => {
    const collection = db.collection("messages");
